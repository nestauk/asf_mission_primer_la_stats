from cleaning import form_emissions_data, form_percentage_changes
...
overall_per_capita['emissions_per_capita'] = overall_per_capita['total_emissions'] / overall_per_capita['population']
...
region_sums['domestic_emissions_per_capita'] = region_sums['total_domestic_emissions'] / region_sums['total_population']
...
regions_with_05_vals['total_as_perc_05'] = regions_with_05_vals['total_domestic_emissions'] / regions_with_05_vals['total_05']
regions_with_05_vals['pc_as_perc_05'] = regions_with_05_vals['domestic_emissions_per_capita'] / regions_with_05_vals['pc_05']
...
big_per_capita_emitters_2005 = (
    full
    [full['year'] == 2005]
    .sort_values('emissions_per_capita')
    .tail()
    ['la_name']
)
...
percentage_changes[(percentage_changes.total_percentage_decrease > 45) & (percentage_changes.total_emissions_2005 > 1300)]

percentage_changes[(percentage_changes.pc_percentage_decrease > 45) & (percentage_changes.pc_emissions_2005 > 3.5)]
